<template>
  ...
  <div class="grid grid-cols-4 gap-3 px-2 overflow-y-scroll h-1/2">
      <card v-for="(ele, index) in items" :key="index" :title="ele.title"
            :img="ele.img" :point="ele.point" :stars="ele.stars" :price="ele.price"/>
  </div>
